...
- Sign up for Neo4j Sandbox: <https://sandbox.neo4j.com/login?ref=sandbox-lp-cta>
  - This runs Neo4j in your browser and is the **Preferred Option** for this lab
- Alternatively, you could install the Neo4j Desktop version from the Neo4j Developer page (<https://neo4j.com/developer/>).
  - This setup requires additional steps and is **Not Preferred** for this lab.
  - Neo4j Desktop: <https://neo4j.com/docs/getting-started/#neo4j-tools>
  - Download Paradise Papers dataset: <https://offshoreleaks.icij.org/pages/database>
...
- **If using the Neo4j Sandbox version (in your browser):**
  ...
  - Click on "Open with browser" and then "Sandbox login"
  - A browser tab will open including access to Neo4j
  - In that tab, there is a panel to the left with 5 different sections that you should read and understand
...
- Join us in Queens Building 1.80 for the Introduction to the lab
- Next, read the task specification and start working on the lab tasks
- At the end, share your findings with others on your table
