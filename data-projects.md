...
Data, metadata, and other information can all be found at this server: 
- https://data.bris.ac.uk/data/dataset/8gccwpx47rav19vk8x4xapcog  


## Project 5. European Productivity  
The EU Open Data portal maintains many datasets related to social and economic trends across the EU. For example, the data on labour productivity per hour worked, or economic sentiment: 
